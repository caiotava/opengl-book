#ifndef OPENGL_BOOK_SCENEPLAINREDCUBE_H
#define OPENGL_BOOK_SCENEPLAINREDCUBE_H
...
class ScenePlainRedCube final : public core::Scene {
public:
    ScenePlainRedCube() : Scene("4.1 Plain Red Cube") {
...
#endif //OPENGL_BOOK_SCENEPLAINREDCUBE_H
